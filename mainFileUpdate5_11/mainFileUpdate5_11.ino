  ...
  if(Serial.available())
  {
    ...
    if(Serial.available()){
      ...
      break;}
        ...
        Serial.println("Yeah you got that right, you are cautious about ur belongings right!!!BC");
        Serial.println("Yeah Yeah System ready!!!Saale ***tiye");
      break;}
    }}
    break;
  }}
